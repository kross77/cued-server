...
class Login extends Component {
  ...
  authenticate (username, password) {
    ...
    if (
      Config.adminConfig.allowedUsers != null &&
      Config.adminConfig.allowedUsers.indexOf(username) == -1
    ) {
  ...
  showGoogleLogin () {
    if (
      Config.adminConfig.allowedUsers != null &&
      Config.adminConfig.allowedUsers.length > 0 &&
      Config.adminConfig.allowGoogleAuth
    ) {
      return (
        <div>
          <p className='category text-center'>
            <a
              ...
              className='btn btn-social btn-fill btn-google'
            >
      ...
      <div>
        ...
        <div className='wrapper wrapper-full-page'>
          <div
            ...
            data-image='assets/img/lock.jpeg'
          >
