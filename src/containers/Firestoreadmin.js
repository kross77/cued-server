      ...
      <div className='content'>
        ...
        <div className='content' sub={this.state.lastSub}>
          ...
          <div className='container-fluid'>
            ...
            {/* COLLECTIONS */}
            {this.state.theSubLink == null && this.state.isDocument &&
                  ...
                  <form method='get' action='/' className='form-horizontal'>
                    ...
                    <div className='col-md-12'>
                      {this.state.elements ? this.state.elements.map((item) => {
                        ...
                        return (
                          <Link
                            onClick={() => { this.showSubItems(theLink) }}><a
        ...
        <SkyLight hideOnOverlayClicked ref='addCollectionDialog' title=''>
          ...
          <div className='col-sm-12' style={{marginTop: 80}}>
            <div className='col-sm-6'/>
            <div className='col-sm-3 center-block'>
              <a onClick={this.cancelAddFirstItem}
                 className='btn btn-info center-block'>Cancel</a>
            </div>
            <div className='col-sm-3 center-block'>
              <a onClick={() => {
                this.addDocumentToCollection(this.state.currentCollectionName)
...
const withConfig = createPromiseHOC(getFirestoreSchema, 'schema',
  () => <h1>Loading firestore schema...</h1>)

const hoc = compose(
  withConfig,
  traceProps('FirestoreAdmin'),
)

const EnahancedFirestroreAdmin = hoc(Firestoreadmin)

export default EnahancedFirestroreAdmin
